...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_every', action='store', type=int, default=1000000, help='eval_every', required=False)
    parser.add_argument('--validate_every', action='store', type=int, default=1000000, help='validate_every', required=False)
    parser.add_argument('--save_every', action='store', type=int, default=100000, help='save_every', required=False)
    parser.add_argument('--resume_ckpt_path', action='store', type=str, help='resume_ckpt_path', required=False,default='/home/mamager/Documents/scripted_sim/aloha_right_grasp/ckpt_rightgrasp/policy_last.ckpt')#default='/home/mamager/interbotix_ws/src/aloha/act-plus-plus/ckpt++/policy_step_500000_seed_0.ckpt')
