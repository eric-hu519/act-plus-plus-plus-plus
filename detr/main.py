...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_dir',default='ckpt', action='store', type=str, help='ckpt_dir')
    parser.add_argument('--policy_class',default='ACT', action='store', type=str, help='policy_class, capitalize')
    parser.add_argument('--task_name',default='sim_transfer_cube_human', action='store', type=str, help='task_name')
    parser.add_argument('--seed',default=0, action='store', type=int, help='seed',)
    parser.add_argument('--num_steps',default=10000, action='store', type=int, help='num_epochs' )
    ...
    parser.add_argument('--save_every', action='store', type=int, default=2000, help='save_every', required=False)
