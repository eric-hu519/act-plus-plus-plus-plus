...
DATA_DIR = os.path.expanduser('~/Documents/scripted_sim')
TASK_CONFIGS = {
    'aloha_mobile_dummy':{
    ...
    'aloha_grasp':{
        ...
        'aloha_left_grasp':{
        'dataset_dir': DATA_DIR + '/aloha_left_grasp',
        'episode_len': 1000,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
        'aloha_right_grasp':{
        'dataset_dir': DATA_DIR + '/aloha_right_grasp',
        'episode_len': 800,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
    'aloha_screw_driver':{
...
MASTER_GRIPPER_JOINT_OPEN = 0.3
MASTER_GRIPPER_JOINT_CLOSE = -0.2
